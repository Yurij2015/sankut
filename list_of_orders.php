...
<section id="admin" class="container text-center">
    ...
    <div class="container">
        <div class="center">
            ...
            <p class="lead">Список заказов</p>
            <p class="lead"><a href="list_of_orders_1_days.php">Заказы за последний день</a> | <a href="list_of_orders_3_days.php">Заказы за последние 3 дня</a> | <a href="list_of_orders_7_days.php">Заказы за последние 7 дней</a></p>
        </div>
        ...
        $sql = "SELECT id, name, email, phone_number, service.name_of_service, furniture.name_of_furniture, wishes FROM orders, furniture, service WHERE service.id_service = orders.service and furniture.id_furniture = orders.furniture";
        $reception = $pdo->query($sql);
        $rows = $reception->fetchAll(PDO::FETCH_CLASS, "Show_orders");
